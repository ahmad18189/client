...
scheduler_events = {
	"daily": [
		'client.api.hooked_leave_allocation_builder',
		'client.api.increase_leave_balance',
		'client.hr_services.doctype.governmental_documents.governmental_documents.governmental_documents_validate_check'
	]
}
